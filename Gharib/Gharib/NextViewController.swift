...
class NextViewController: UIViewController, G8TesseractDelegate  {
    ...
    private func configureCamera() {
        ...
        self.cameraView.videoPreviewLayer.videoGravity = .resize
...
extension NextViewController: AVCaptureVideoDataOutputSampleBufferDelegate {
